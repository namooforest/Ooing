...
const SamsungCardParserV1 = (() => {
  ...
  function parseSamsungPageText(text) {
    ...
    const targetText = removeForeignSectionText(text);
  ...
  function removeForeignSectionText(text) {
    ...
    if (nextSection > 0) return before + after.substring(nextSection);
    return before;
  }
